...
class SolutionTest {
    ...
    @Test
    void countSmaller() {
        assertArrayEquals(new Integer[]{2,1,1,0}, solution.countSmaller(new int[]{5,2,6,1}).toArray());
        assertArrayEquals(new Integer[]{10,27,10,35,12,22,28,8,19,2,12,2,9,6,12,5,17,9,19,12,14,6,12,5,12,3,0,10,0,7,8,4,0,0,4,3,2,0,1,0},
